...
//        .map(Point::toString).collect(Collectors.joining(", "));
  ...
  public static void main(String[] args) {
    ...
    verboseDebug = environment.containsKey("SEEKER_V3_VERBOSE_DEBUG");
    debug = environment.containsKey("SEEKER_V3_DEBUG");

    Seeker_V3 seeker = new Seeker_V3();
    seeker.run();
  }
