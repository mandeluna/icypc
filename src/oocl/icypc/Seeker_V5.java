...
//        .map(Point::toString).collect(Collectors.joining(", "));
  ...
  public static void main(String[] args) {
    ...
    verboseDebug = environment.containsKey("SEEKER_V5_VERBOSE_DEBUG");
    debug = environment.containsKey("SEEKER_V5_DEBUG");

    Seeker_V5 seeker = new Seeker_V5();
    seeker.run();
  }
