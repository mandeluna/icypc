...
//        .map(Point::toString).collect(Collectors.joining(", "));
  ...
  public static void main(String[] args) {
    ...
    verboseDebug = environment.containsKey("SEEKER_V4_VERBOSE_DEBUG");
    debug = environment.containsKey("SEEKER_V4_DEBUG");

    Seeker_V4 seeker = new Seeker_V4();
    seeker.run();
  }
